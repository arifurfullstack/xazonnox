...
export class CourierService {
  ...
  public async getOrderStatusFormCourier(
    ...
    const { providerName, apiKey, secretKey, username, password } = courierApiConfig;
    ...
    switch (providerName) {
      case 'Steadfast Courier':
        try {
          ...
          console.error(`[Steadfast Error] CID: ${consignmentId}`, error?.response?.data || error.message);
          return {
            error: true,
      ...
      case 'Pathao Courier':
        try {
          ...
          console.error(`[Pathao Error] CID: ${consignmentId}`, error?.response?.data || error.message);
          return {
            error: true,
