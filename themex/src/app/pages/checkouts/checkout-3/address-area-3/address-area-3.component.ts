...
@Component({
  ...
  templateUrl: './address-area-3.component.html',
  styleUrl: './address-area-3.component.scss'
})
export class AddressArea3Component implements OnInit, OnChanges, OnDestroy {
