...
@Component({
  selector: 'app-delivery-charge-3',
  standalone: true,
  imports: [
    TitleComponent,
    PaymentCardLoaderComponent
  ],
  templateUrl: './delivery-charge-3.component.html',
  styleUrl: './delivery-charge-3.component.scss'
})
export class DeliveryCharge3Component implements OnInit, OnChanges, OnDestroy {
