...
const API_URL = environment.apiBaseLinkSaleecom + '/api/support/';
...
export class SupportService {
  ...
  addSupport(data: Support) {
    return this.httpClient.post<{ message: string, success: boolean }>(API_URL + 'add-by-clint', data);
  }
  ...
  getAllSupports(filterData: FilterData, searchQuery?: string) {
    ...
    return this.httpClient.post<{
      ...
      success: boolean,
      maxLimit: any
    }>(API_URL + 'get-all-by-clint-shop', filterData, {params});
  }
